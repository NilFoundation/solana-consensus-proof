...
inline bool configure_aspects(boost::application::context &ctx, Application &app) {
    typedef nil::proof::detail::configurable<nil::dbms::plugin::variables_map, nil::dbms::plugin::cli_options_description,
...
public:
    ...
    int operator()() {
        ...
        (void) nil::actor::engine().when_started().then(std::move(proof_gen));
